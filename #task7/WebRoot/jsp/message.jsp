										...
										<p class="c_meta">
											...
											<span class="c_time">
												<c:if test="${host.userid==receiver.userid }">
											  	   <a href="<%=path %>/user/deleteMessage?messageid=${message.message.messageid}&receiveid=${receiver.userid }&currentPage=${pager.pageNum }" onclick="return operaconfirm('删除');">删除</a>
												</c:if>
											</span>
										</p>
